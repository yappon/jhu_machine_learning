...
Run Random Forest algorithm to build the predicting model - turned on allowParallel parameter in trainControl and set mtry=14 as obtained in tuneRF()
```{r cache=TRUE}
...
Accuracy of the model is 99.68%.
```{r}
fit$results
```
